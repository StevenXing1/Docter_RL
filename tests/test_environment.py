...
class TestDocterEnv:
    ...
    def test_step(self, env):
        ...
        for action in range(env.action_space.n):
            ...
            # Handle both old (4-tuple) and new (5-tuple) API
            if len(result) == 5:
    ...
    @pytest.mark.skip(
        reason="Environment has inherent non-determinism in physics simulation"
    )
    def test_deterministic_seed(self):
        ...
        seed = 42
        result1 = env1.reset(seed=seed)
        result2 = env2.reset(seed=seed)

        state1 = result1[0] if isinstance(result1, tuple) else result1
        state2 = result2[0] if isinstance(result2, tuple) else result2
        ...
        for _ in range(10):
            ...
            if len(result1) == 5:
                s1, r1, t1, tr1, _ = result1
                s2, r2, t2, tr2, _ = result2
                d1 = t1 or tr1
                d2 = t2 or tr2
            else:
                s1, r1, d1, _ = result1
